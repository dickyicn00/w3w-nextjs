...
const Sponsor = () => {
  return (
    <>
      <section
        id="sponsor"
        className="grid grid-cols-4 sm:grid-cols-4 mt-20 sm:mt-24 lg:mt-[136px] px-0 sm:px-4"
      >
        <SubHeadingBtn
          className="flex flex-row items-center justify-between mb-15"
          title="Sponsor"
          classNameBtn="text-xs lg:text-sm -mt-1.5 sm:mt-0 py-2 sm:py-3 lg:py-3 px-3 sm:px-6 lg:px-6"
